...
const s = {
  ...
  name: { fontFamily: 'Cormorant Garamond, serif', fontSize: '22px', color: 'var(--text-dark)', fontWeight: '400' },
  ...
  btn: {
    ...
    padding: '9px 20px', borderRadius: 'var(--radius)', fontSize: '12px',
    letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: '500', cursor: 'pointer',
    transition: 'all 0.2s',
  },
  btnAdded: {
    background: 'var(--gold)',
